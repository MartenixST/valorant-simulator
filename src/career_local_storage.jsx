...
export function finalizeLoad(foundSave, actualId) {
    ...
    // Initialize tutorial state for existing saves
    if (foundSave.tutorialCompleted === undefined) {
        // If they've already progressed past week 1, assume they don't need the tutorial
        foundSave.tutorialCompleted = foundSave.week > 1;
        foundSave.tutorialStep = 0;
    }
